...
import com.example.bluetoothtest.util.ClsUtils;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void startConnectDevice(final BluetoothDevice bluetoothDevice, String uuid, long conOutTime){
        ...
        connectThread = new ConnectThread(this,bluetoothAdapter,curBluetoothDevice,uuid);
